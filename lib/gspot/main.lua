...
love.load = function()
	...
	scrll = gui:scroll("azaza", {50, 50, gui.style.unit, 100}, nil, {0, 100, 20, 20, 'vertical'})

	scrll.drop = function(this) gui:feedback('Scrolled to : '..this.values.current..' / '..this.values.min..' - '..this.values.max) end

	--scrll.style.hs = scrll.style.unit*2
...
love.draw = function()
	love.graphics.print(scrll.values.current)
